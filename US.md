...
### 2. UC1.2: Đăng nhập hệ thống (Email/SĐT)
- **Mã Use Case:** UC1.2
...
### 3. UC1.3: Đăng nhập qua mạng xã hội (OAuth Google/Facebook)
- **Mã Use Case:** UC1.3
- **Tác nhân:** Khách
...
### 4. UC1.4: Quên mật khẩu & Đặt lại mật khẩu
- **Mã Use Case:** UC1.4
- **Tác nhân:** Người dùng
...
### 5. UC1.5 & UC1.6: Xem và Cập nhật thông tin cá nhân
- **Mã Use Case:** UC1.5 & UC1.6
- **Tác nhân:** Người dùng
...
### 9. UC2.2: Xem thông tin nhóm gia đình & Danh sách thành viên
- **Mã Use Case:** UC2.2
...
### 10. UC2.3: Tạo mã mời/Link mời thành viên mới
- **Mã Use Case:** UC2.3
- **Tác nhân:** Người dùng (Owner)
...
### 11. UC2.4: Tham gia nhóm gia đình
- **Mã Use Case:** UC2.4
- **Tác nhân:** Người dùng
...
### 12. UC2.5: Cập nhật phân quyền cho thành viên
- **Mã Use Case:** UC2.5
- **Tác nhân:** Người dùng (Owner)
...
### 13. UC2.6: Xóa thành viên khỏi nhóm (Kick)
- **Mã Use Case:** UC2.6
- **Tác nhân:** Người dùng (Owner)
...
### 14. UC2.7: Rời khỏi nhóm gia đình
- **Mã Use Case:** UC2.7
...
### 15. UC3.1: Tạo mới danh sách mua sắm
- **Mã Use Case:** UC3.1
...
### 16. UC3.2 & UC3.3: Xem, Sửa tên, Xóa danh sách mua sắm
- **Mã Use Case:** UC3.2 & UC3.3
- **Tác nhân:** Người dùng (Quyền Edit List)
- **Luồng sự kiện chính:**
...
### 17. UC3.4: Thêm mặt hàng vào danh sách
- **Mã Use Case:** UC3.4
- **Tác nhân:** Người dùng (Quyền Edit List)
- **Luồng sự kiện chính:**
...
### 18. UC3.5 & UC3.6: Cập nhật và Xóa mặt hàng
- **Mã Use Case:** UC3.5 & UC3.6
- **Tác nhân:** Người dùng (Quyền Edit List)
- **Luồng sự kiện chính:**
...
### 19. UC3.7 & UC3.8: Đánh dấu đã mua và Tự động chuyển vào Tủ lạnh
- **Mã Use Case:** UC3.7 & UC3.8
- **Tác nhân:** Người dùng
...
### 20. UC4.1 & UC4.5: Xem và Tìm kiếm thực phẩm trong kho
- **Mã Use Case:** UC4.1 & UC4.5
- **Tác nhân:** Người dùng
- **Luồng sự kiện chính:**
  1. Vào tab "Tủ lạnh".
...
### 21. UC4.2: Thêm mới thực phẩm vào tủ lạnh (Thủ công)
- **Mã Use Case:** UC4.2
...
### 22. UC4.3: Cập nhật thông tin thực phẩm
- **Mã Use Case:** UC4.3
- **Tác nhân:** Người dùng (Quyền Edit Pantry)
- **Luồng sự kiện chính:**
...
### 23. UC4.4: Xóa/Thanh lý thực phẩm
- **Mã Use Case:** UC4.4
- **Tác nhân:** Người dùng (Quyền Edit Pantry)
...
### 24. UC4.6: Tự động trừ số lượng thực phẩm khi nấu ăn
- **Mã Use Case:** UC4.6
- **Tác nhân:** Hệ thống
- **Luồng sự kiện chính:**
...
### 25. UC4.7: Gửi thông báo nhắc nhở thực phẩm sắp hết hạn
- **Mã Use Case:** UC4.7
...
### 26. UC5.1 & UC5.2: Xem lịch trình và Tạo phiên ăn
- **Mã Use Case:** UC5.1 & UC5.2
- **Tác nhân:** Người dùng
- **Luồng sự kiện chính:**
...
### 27. UC5.3 & UC5.4: Thêm và Sửa món ăn trong lịch trình
- **Mã Use Case:** UC5.3 & UC5.4
- **Tác nhân:** Người dùng
- **Luồng sự kiện chính:**
...
### 28. UC5.5: Xóa món ăn khỏi lịch trình
- **Mã Use Case:** UC5.5
- **Tác nhân:** Người dùng
- **Luồng sự kiện chính:**
...
### 29. UC6.1: Gợi ý món ăn dựa trên thực phẩm hiện có
- **Mã Use Case:** UC6.1
...
### 30. UC6.2 & UC6.3: Tìm kiếm và Xem chi tiết công thức
- **Mã Use Case:** UC6.2 & UC6.3
- **Tác nhân:** Người dùng
- **Luồng sự kiện chính:**
...
### 31. UC6.4: Lưu/Bỏ lưu công thức yêu thích
- **Mã Use Case:** UC6.4
- **Tác nhân:** Người dùng
- **Luồng sự kiện chính:**
...
### 32. UC6.5: Tự động thêm nguyên liệu còn thiếu vào Danh sách mua sắm
- **Mã Use Case:** UC6.5
- **Tác nhân:** Người dùng
- **Luồng sự kiện chính:**
...
### 33. UC6.6: Chat tương tác với AI Chef
- **Mã Use Case:** UC6.6
...
### 34. UC7.1 & UC7.2: Xem thống kê tiêu dùng và lãng phí
- **Mã Use Case:** UC7.1 & UC7.2
- **Tác nhân:** Người dùng
- **Luồng sự kiện chính:**
  1. Vào tab "Thống kê".
...
### 37. UC8.4 & UC8.5: Quản lý Master Data (Thực phẩm, Đơn vị tính)
- **Mã Use Case:** UC8.4 & UC8.5
- **Tác nhân:** Admin
- **Luồng sự kiện chính:**
...
### 38. UC8.6: Kiểm duyệt công thức nấu ăn
- **Mã Use Case:** UC8.6
- **Tác nhân:** Admin
- **Luồng sự kiện chính:**
...
### 39. UC8.7: Xem Dashboard tổng quan
- **Mã Use Case:** UC8.7
- **Tác nhân:** Admin
- **Luồng sự kiện chính:**
